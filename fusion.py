...
class FusionTransformer(nn.Module):
    def __init__(self, d_model=256, n_heads=8, n_layers=4, dropout=0.1):
        ...
        # self-attention over vision + text to build rich context
        ...
        # cross-attention — state queries attend to vision+text context
    ...
    def forward(self, vision_tokens, text_tokens, state_tokens):
        ...
        # state tokens query the context
        # "where is the target relative to my gripper?" gets answered here
